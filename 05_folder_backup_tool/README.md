...
**Create a verified archive with a cryptographic record of every file.**

A ZIP file alone does not prove which files were captured or whether they later changed.

Product 005 turns that work into a compressed backup, embedded SHA-256 manifest, verification result and executive evidence report. The visual application is designed for first-time users, while the underlying engine and audit artifacts remain useful to technical reviewers and recruiters.
...
- Recursive folder capture
- SHA-256 fingerprint for every file
- Manifest embedded inside the archive
...
**Cooke Automation Systems · Product 005 · Version 2.0.0**
