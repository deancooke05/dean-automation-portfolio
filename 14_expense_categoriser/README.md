# Product 014 — Expense Categoriser

![Cooke Automation Systems](../brand/logo.svg)

**Turn raw transactions into a transparent spending view.**

Uncategorised transaction exports make it difficult to understand where business money is going.

Product 014 turns that work into categorised transactions, category totals, spending shares and review insights. The visual application is designed for first-time users, while the underlying engine and audit artifacts remain useful to technical reviewers and recruiters.
...
- Visible keyword-based category rules
- Software, travel, office and marketing categories
- Uncategorised 'Other' visibility
...
**Cooke Automation Systems · Product 014 · Version 2.0.0**
