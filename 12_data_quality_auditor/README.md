# Product 012 — Data Quality Auditor

![Cooke Automation Systems](../brand/logo.svg)

**Measure missing data, duplicates and structural weaknesses before they spread.**

Poor-quality CSV data quietly damages reporting, imports and customer communication.

Product 012 turns that work into a repeatable quality score, field completeness, duplicate counts and a prioritised action view. The visual application is designed for first-time users, while the underlying engine and audit artifacts remain useful to technical reviewers and recruiters.
...
- Field-by-field missing-value analysis
- Exact duplicate-row measurement
- Explainable quality baseline
- No guessed or destructive data repairs
...
**Cooke Automation Systems · Product 012 · Version 2.0.0**
