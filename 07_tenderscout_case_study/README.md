# Product 007 — Tender Opportunity Scorer

![Cooke Automation Systems](../brand/logo.svg)

**Rank opportunities by strategic fit, value and relevant capability.**

Teams lose hours opening public opportunities that are low value or poorly matched to their capabilities.

Product 007 turns that work into an explainable ranked shortlist, keyword evidence, value thresholds and bid-review recommendations. The visual application is designed for first-time users, while the underlying engine and audit artifacts remain useful to technical reviewers and recruiters.
...
- Editable capability keyword profile
- Configurable minimum contract value
- Visible score evidence and recommendations
- Human bid/no-bid decision retained
...
**Cooke Automation Systems · Product 007 · Version 2.0.0**
