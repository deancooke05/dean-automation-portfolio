# Product 008 — Duplicate File Finder

![Cooke Automation Systems](../brand/logo.svg)

**Find wasted storage using content evidence—not unreliable filenames.**

Duplicate files often have different names, while identically named files may contain different content.

Product 008 turns that work into exact duplicate groups, potential storage savings, hash evidence and a zero-deletion review workflow. The visual application is designed for first-time users, while the underlying engine and audit artifacts remain useful to technical reviewers and recruiters.
...
- Size-assisted SHA-256 comparison
- Potential reclaimable storage calculation
- Exact group membership evidence
...
**Cooke Automation Systems · Product 008 · Version 2.0.0**
