# Product 017 — Folder Change Monitor

![Cooke Automation Systems](../brand/logo.svg)

**Create a cryptographic baseline and reveal exactly what changed.**

Teams often know a folder changed without knowing which files were added, removed or altered.

Product 017 turns that work into a refreshed baseline, added/changed/removed evidence and SHA-256 fingerprints. The visual application is designed for first-time users, while the underlying engine and audit artifacts remain useful to technical reviewers and recruiters.
...
- Added, removed and changed classification
...
**Cooke Automation Systems · Product 017 · Version 2.0.0**
