# Product 010 — Image Library Auditor

![Cooke Automation Systems](../brand/logo.svg)

**Catalogue image assets, verify integrity and plan consistent names.**

Image libraries accumulate unclear names, uncertain duplicates and no integrity record.

Product 010 turns that work into an asset catalogue, suggested naming plan, SHA-256 fingerprints and duplicate visibility. The visual application is designed for first-time users, while the underlying engine and audit artifacts remain useful to technical reviewers and recruiters.
...
- Consistent numbered rename suggestions
- Content fingerprints and library sizing
- Audit-only workflow with no automatic rename
...
**Cooke Automation Systems · Product 010 · Version 2.0.0**
