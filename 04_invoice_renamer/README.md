...
**Give every invoice a consistent, searchable and audit-friendly name.**

Supplier invoices arrive with inconsistent filenames, making finance folders slow to search and easy to misfile.

Product 004 turns that work into a compulsory rename preview, collision checks, an approval action and a complete audit report. The visual application is designed for first-time users, while the underlying engine and audit artifacts remain useful to technical reviewers and recruiters.
...
- Date, supplier and invoice-number naming convention
- Missing-source and existing-target validation
- Preview before any filename changes
- Transparent apply step with no overwrites
...
**Cooke Automation Systems · Product 004 · Version 2.0.0**
